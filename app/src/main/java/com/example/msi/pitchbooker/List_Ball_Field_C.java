 ...
 */
public class List_Ball_Field_C extends Fragment {
    TextView f1, f2, f3, f4, f5, f6;
    static String day;
    private ListView listItem;
    private ArrayList<Table_Field_value> values;
    private ArrayList<String> times;
    private List_Item_C items;
    public static String[] pitch = {"C 1", "C 2", "C 3", "C 4", "C 5", "C 6"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items = new List_Item_C(getActivity(), times, values);
    ...
    private void ListBallField() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                // A Field Location
                ArrayList<Field> fields = list.getLocations().get(2).getFields();
                ...
                if (list.isStatus()) {
                    f1.setText(list.getLocations().get(2).getFields().get(0).getField_name());
                    f2.setText(list.getLocations().get(2).getFields().get(1).getField_name());
                    f3.setText(list.getLocations().get(2).getFields().get(2).getField_name());
                    f4.setText(list.getLocations().get(2).getFields().get(3).getField_name());
                    f5.setText(list.getLocations().get(2).getFields().get(4).getField_name());
                    f6.setText(list.getLocations().get(2).getFields().get(5).getField_name());
                }
