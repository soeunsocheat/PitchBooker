...
//            if (values.get(0).getPitch() != 400 && values.get(position).getT11() != ts1) {
//                f11.setBackgroundColor(Color.RED);
////                f21.setBackgroundColor(Color.BLACK);
//            }
//            if(values.get(0).getPitch() != 400 && values.get(position).getT11() != ts2){
//                f21.setBackgroundColor(Color.RED);
//            }
//            if (values.get(0).getPitch() != 401 && values.get(position).getT11() != ts3) {
//                f12.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 401 && values.get(position).getT11() != ts4){
//                f22.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 401 && values.get(position).getT11() != ts5){
//                f13.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 402 && values.get(position).getT11() != ts6){
//                f23.setBackgroundColor(Color.RED);
//            }
//             if (values.get(0).getPitch() != 403 && values.get(position).getT11() != ts7) {
//                f14.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 403 && values.get(position).getT11() != ts8){
//                f24.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 404 && values.get(position).getT11() != ts9){
//                f15.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 404 && values.get(position).getT11() != ts10){
//                f25.setBackgroundColor(Color.RED);
//            }
//             if (values.get(0).getPitch() != 405 && values.get(position).getT11() != ts11) {
//                f16.setBackgroundColor(Color.RED);
//            }
//             if(values.get(0).getPitch() != 405 && values.get(position).getT11() != ts12) {
