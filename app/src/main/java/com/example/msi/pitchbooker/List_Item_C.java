...
public class List_Item_C extends ArrayAdapter<String>{
    ...
    public List_Item_C(@NonNull Context context, @NonNull List<String> objects, List<Table_Field_value> values) {
...
//        if (values.get(0).getPitch() != 300 && values.get(position).getT11() != ts1) {
//            f11.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 300 && values.get(position).getT11() != ts2){
//            f21.setBackgroundColor(Color.RED);
//        }
//        if (values.get(0).getPitch() != 301 && values.get(position).getT11() != ts3) {
//            f12.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 301 && values.get(position).getT11() != ts4){
//            f22.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 301 && values.get(position).getT11() != ts5){
//            f13.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 302 && values.get(position).getT11() != ts6){
//            f23.setBackgroundColor(Color.RED);
//        }
//        if (values.get(0).getPitch() != 303 && values.get(position).getT11() != ts7) {
//            f14.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 303 && values.get(position).getT11() != ts8){
//            f24.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 304 && values.get(position).getT11() != ts9){
//            f15.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 304 && values.get(position).getT11() != ts10){
//            f25.setBackgroundColor(Color.RED);
//        }
//        if (values.get(0).getPitch() != 305 && values.get(position).getT11() != ts11) {
//            f16.setBackgroundColor(Color.RED);
//        }
//        if(values.get(0).getPitch() != 305 && values.get(position).getT11() != ts12) {
...
//        }
    ...
    private void book_pitch() {
        ...
        List_Ball_Field_C c = new List_Ball_Field_C();
        day = c.day;
