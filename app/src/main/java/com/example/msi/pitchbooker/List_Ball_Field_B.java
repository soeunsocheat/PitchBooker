...
public class List_Ball_Field_B extends Fragment {
    ...
    private List_Item_B items;
    public static String[] pitch = {"B 1", "B 2", "B 3", "B 4", "B 5", "B 6"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items = new List_Item_B(getActivity(), times, values);
    ...
    private void ListBallField() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                // A Field Location
                ArrayList<Field> fields = list.getLocations().get(1).getFields();
                ...
                if (list.isStatus()) {
                    f1.setText(list.getLocations().get(1).getFields().get(0).getField_name());
                    f2.setText(list.getLocations().get(1).getFields().get(1).getField_name());
                    f3.setText(list.getLocations().get(1).getFields().get(2).getField_name());
                    f4.setText(list.getLocations().get(1).getFields().get(3).getField_name());
                    f5.setText(list.getLocations().get(1).getFields().get(4).getField_name());
                    f6.setText(list.getLocations().get(1).getFields().get(5).getField_name());
                }
